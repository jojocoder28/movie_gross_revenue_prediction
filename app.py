...
runtime = st.sidebar.slider("Runtime (in minutes)", df['runtime'].min(),df['runtime'].max(),df['runtime'].median())
votes = st.sidebar.slider("Votes (in thousands)", df['votes'].min(),df['votes'].max(),df['votes'].median())
