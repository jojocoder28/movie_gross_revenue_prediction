...
votes = st.sidebar.slider("Votes", df['votes'].min(),df['votes'].max(),int(df['votes'].median()))
budget = st.sidebar.number_input("Budget", min_value=df['budget'].min(),max_value=df['budget'].max(), value=int(df['budget'].median()))
